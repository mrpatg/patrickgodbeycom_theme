...
function b4st_enqueues() {
	...
	wp_register_style('bootstrap-css', get_template_directory_uri() . '/theme/css/bootstrap4-custom.min.css', false, '4.0.0-beta.2', null);
	wp_enqueue_style('bootstrap-css');

	wp_register_style('font-awesome-css', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/css/all.min.css', false, '5.11.2', null);
	...
	wp_register_script('jquery-3.2.1', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js', false, '3.4.1', true);
